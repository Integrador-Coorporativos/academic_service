package br.com.ifrn.EvaluationsService.evaluations_service.messaging.config;
...
public class RabbitMQConfig {
    ...
    public MessageConverter jsonMessageConverter() {
        ...
        classMapper.setTrustedPackages("*"); // permite desserializar qualquer pacote, ajuste se necessário
        Map<String, Class<?>> idClassMapping = new HashMap<>();
        idClassMapping.put(
                "br.com.ifrn.ClassService.messaging.dto.CreateClassMessageDTO",
                ConsumerMessageDTO.class
        );
    ...
    @Bean
    public Binding bindingClassServiceProducerQueue(Queue requestQueue, TopicExchange exchange) {
